...
class Settings:
    ...
    TASK3_MIN_QUALITY_SCORE: float = 0.35
    TASK3_FALLBACK_MIN_QUALITY_SCORE: float = 0.55
    TASK3_MIN_INLIER_RATIO: float = 0.25
    TASK3_CONFLICT_IOU_THRESHOLD: float = 0.35
    ...
    CB_MAX_NO_PROGRESS_SEC: float = CB_SESSION_MAX_TRANSIENT_SEC
    CB_MAX_OPEN_CYCLES_WITHOUT_PROGRESS: int = CB_MAX_OPEN_CYCLES
    ...
    PAYLOAD_DEDUP_IOU_THRESHOLD: float = 0.55
    PAYLOAD_DEDUP_LANDING_IOU_THRESHOLD: float = 0.45
